...
type AppendArgument1<Fn extends (...params: any[]) => any, A> = Fn extends (...args: infer R) => infer M ? (...args: [...R, A]) => M : never;

type AppendArgument<Fn extends (...params: any[]) => any, A> = (...params: [...Parameters<Fn>, A]) => ReturnType<Fn>
