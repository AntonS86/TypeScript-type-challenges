...
type TupleToNestedObject<T extends unknown[], U> = T extends [infer A extends string, ...infer B] 
? {[P in A]: TupleToNestedObject<B, U>} 
: U; 

type m = TupleToNestedObject<['a', 'b', 'c'], boolean>;
//   ^?
