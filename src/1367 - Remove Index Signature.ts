...
type TypeLiteral<P> = string extends P ? never : number extends P ? never : symbol extends P ? never : P

type RemoveIndexSignature<T> = {
  [P in keyof T as TypeLiteral<P>]: T[P] ;
}
type m = RemoveIndexSignature<Foo>;
//   ^?
